...
import StyledHmrcOdxDateWrapper from './styles';
...
const HmrcOdxDate = props => {
  ...
  if (
    ...
    const displayComp = (
      <DateTimeDisplay variant={variantValue} format={formatValue} value={value} />
    );
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return <StyledHmrcOdxDateWrapper> displayComp </StyledHmrcOdxDateWrapper>;
      }
      case 'LABELS_LEFT': {
        return (
          <StyledHmrcOdxDateWrapper>
            <FieldValueList
