...
import HmrcOdxMimicASentence from './index'; //import the component to test
...
export default {
  title: 'HmrcOdxMimicASentence',
  component: HmrcOdxMimicASentence
};
